...
installmentRoutes
    .route('/')
    .post(async (req, res) => installmentControle.create(req, res))
    .get(async (req, res) => installmentControle.searchAll(req, res));

installmentRoutes
    .route('/:id')
    .get(async (req, res) => installmentControle.searchById(req, res))
    .put(async (req, res) => installmentControle.update(req, res))
    .delete(async (req, res) => installmentControle.delete(req, res))
